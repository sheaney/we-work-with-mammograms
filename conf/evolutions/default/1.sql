...
alter table shared_patient add constraint fk_shared_patient_sharer_11 foreign key (staff_id) references staff (id);
create index ix_shared_patient_sharer_11 on shared_patient (staff_id);
alter table shared_patient add constraint fk_shared_patient_shared_12 foreign key (patient_id) references staff (id);
create index ix_shared_patient_shared_12 on shared_patient (patient_id);
alter table study add constraint fk_study_owner_13 foreign key (patient_id) references patient (id);
